...
- How do we version and test harness configurations? (See [testing-agents.md](problems/testing-agents.md).) (Functional evals now test the full pipeline including harness-assembled configuration — [ADR 0044](ADRs/0044-functional-evals-for-agent-pipelines.md). Harness versioning remains open.)
...
- How are new agent roles added, tested, and promoted to production? (See [testing-agents.md](problems/testing-agents.md).) (Functional evals provide a framework for testing agent roles against controlled fixtures — [ADR 0044](ADRs/0044-functional-evals-for-agent-pipelines.md). Promotion workflow remains open.)
